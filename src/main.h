...
public:
    ...
    {
        CKey key;
        if (!key.SetPubKey(ParseHex("0487a850669bf8362481f2f15cbd36cdccc44f23ba4db816a9b622c0c0ecfd5ea4d52667f6298a00af37c70ceae8e0bd7a78f8cf8d72cb40ec9a4a0dcac4fe913f")))
